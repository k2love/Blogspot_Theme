...
// initializeSubtitleToggles 함수 수정
function initializeSubtitleToggles() {
    const toggleButtonsGroup = document.querySelector('.toggle-buttons-group');
    if (!toggleButtonsGroup) return;

    const toggleButtons = toggleButtonsGroup.querySelectorAll('.toggle-btn');
    ...
    toggleButtons.forEach((button) => {
        ...
        // 줌 버튼을 토글 버튼 앞에 삽입
        toggleButtonsGroup.insertBefore(zoomButton, button);
