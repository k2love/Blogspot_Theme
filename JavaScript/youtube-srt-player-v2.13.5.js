class YouTubeSRTPlayer {
    ...
    updateSubtitles() {
        ...
        [
            { selector: '.subtitle-text-ko', subtitles: this.subtitles.ko, className: 'subtitle-ko' },
            { selector: '.subtitle-text-en', subtitles: this.subtitles.en, className: 'subtitle-en' },
            { selector: '.subtitle-text-extra', subtitles: this.subtitles.extra, className: 'subtitle-extra' },
        ].forEach(({ selector, subtitles, className }) => {
            ...
            contentDiv.innerHTML = currentSubtitle
                ? `<span class="${className}">${currentSubtitle.text.replace(/\n/g, '<br>')}</span>`
                : '';
        });
    }
