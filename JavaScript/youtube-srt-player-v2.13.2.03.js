...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // 미니 플레이어 버튼 이벤트 리스너
        const miniPlayerBtn = document.querySelector('[data-target="mini-player"]');
        console.log('미니 플레이어 버튼 찾음:', miniPlayerBtn);
    ...
    .video-container.mini-player {
        position: fixed;
        width: 400px; /* 유튜브 소형 플레이어와 비슷한 크기로 증가 */
        height: 225px; /* 16:9 비율 유지 */
        z-index: 1000;
        border-radius: 8px;
    ...
    .video-container.mini-player #subtitle-text-ko span {
        font-size: 14px; /* 소형 플레이어용 자막 크기 축소 */
        max-width: 90%;
    }

    .video-container.mini-player #subtitle-text-en span {
        font-size: 11px; /* 소형 플레이어용 영어 자막 크기 축소 */
        max-width: 90%;
    }

    .video-container.mini-player #subtitle-text-extra span {
        font-size: 12px; /* 소형 플레이어용 추가 자막 크기 축소 */
        max-width: 90%;
    }
