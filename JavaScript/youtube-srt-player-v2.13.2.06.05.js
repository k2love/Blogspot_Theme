...
(function () {
    ...
    function toggleMiniPlayer() {
        ...
        if (isMiniPlayer) {
            ...
            videoContainer.style.display = 'block'; // block으로 변경
    ...
    function updateVideoPosition() {
        ...
        if (rect.top < 0) {
            ...
            videoContainer.style.display = 'block'; // fixed 모드에서는 block으로 변경
            ...
            placeholder.style.height = `${videoHeight}px`;
            videoContainer.style.display = 'block'; // fixed-bottom 모드에서는 block으로 변경
            ...
            videoContainer.classList.remove('fixed-bottom');
            placeholder.style.height = '0';
            videoContainer.style.display = 'flex'; // 일반 모드에서는 flex로 복원
    ...
    .subtitle-area#ko-subtitle-area {
        ...
        margin: 0;
        padding: 0;
        order: 1; /* flex order로 영상 위에 배치 */
    }    

    /* fixed 모드일 때 한글 자막 숨김 (옵션) */
