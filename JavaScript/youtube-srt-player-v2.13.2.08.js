...
(function () {
    ...
    function toggleMiniPlayer() {
        ...
        if (isMiniPlayer) {
            ...
            // 미니 플레이어 버튼 아이콘 변경
            const miniPlayerBtn = document.querySelector('button[data-target="mini-player"]');
            if (miniPlayerBtn) {
    ...
    function toggleVideoExpand() {
        ...
        const expandButton = document.querySelector('button[data-target="video-expand"]');
    ...
    function moveControlButtons() {
        ...
        leftButtonsContainer.style.zIndex = '200'; // z-index 값 추가
