...
(function() {
    ...
    function onPlayerStateChange(event) {
        ...
        // 시간 이동 감지 (0.5초 이상 차이나면 시간 이동으로 간주)
        ...
        // 시간 이동이 아니고, 상태가 변경되었을 때만 updateVideoPosition 호출
    ...
    function initializeSubtitleToggles() {
        ...
        // 확장 버튼에 대한 초기화 및 클릭 핸들러
        const expandButton = document.querySelector('.toggle-btn[data-target="video-expand"]');
        if (expandButton) {
